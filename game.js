...
Hoops.MainMenu.prototype = {
    ...
    create: function () {
        ...
        this.stage.backgroundColor = 0x001133;

        var logo = this.add.image(this.world.centerX, 80, 'logo');
        logo.anchor.x = 0.5;

        var start = this.add.bitmapText(this.world.centerX, 460, 'fat-and-tiny', 'CLICK TO PLAY... BRUH', 64);
        start.anchor.x = 0.5;
...
Hoops.Game.prototype = {
    ...
    create: function () {
        ...
        this.stage.backgroundColor = 0xDC143C;
        ...
        this.basket = this.add.sprite(100, 400, 'basket');
